    ...
    <center>
        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="bodyTable"
            ...
            <tbody>
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" valign="top" class="header"
                                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#2EC4B6 url('https://link-to-another-hosted-image.png') repeat-y top;background-size:560px 150px;border-radius:5px 5px 0 0;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:28px 130px;"
                                        bgcolor="#3F3D55">
                                        <!-- // Header block // -->
                                                ...
                                                <tr>
                                                    <td align="center" valign="middle" class="mobile-centered-container"
                                                        ...
                                                        <h1 class="header-heading mobile-centered-item"
                                                            ...
                                                            <strong>{{ $restaurantName }}</strong> ha preso in carico
                                                            il tuo ordine!<span style="font-size:20px">&#127881;</span>
                                                        </h1>
                                                        <div>
                                ...
                                <tr>
                                    <td align="left" valign="top" class="content-item"
                                        ...
                                        <h1
                                            ...
                                            <span class="highlighted-text" style="color: #000">Il tuo ordine è in
                                                cucina!</span>
                                        </h1>
                                        <div>Ordine ID: #{{ $order->id }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" class="content-item"
                                        ...
                                        <h2
                                            style="color:#4A4A4A;font-size:24px;letter-spacing:-.7px;line-height:29px;margin:0;padding:0;">
                                            <span class="highlighted-text" style="color: #000">Riepilogo</span>
                                        </h2>
                                    </td>
                                </tr>
                                <tr>
                                <tr>
                                    <td align="left" valign="top"
                                        ...
                                        @foreach ($order->products as $product)
                                            <div> <span> <strong>{{ $product->pivot->quantity }}</strong></span> -
                                                {{ $product->name }}</div>
                                        @endforeach
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top"
                                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                        <div><strong>Totale: </strong> {{ $order['price'] }} <span> €</span></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top" class="content-item"
                                ...
                                <tr>
                                    <td align="left" valign="top"
                                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                        <div><strong>Cognome: </strong> {{ $order['surname'] }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top"
                                ...
                                <tr>
                                    <td align="left" valign="top"
                                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                        <div><strong>Indirizzo: </strong> {{ $order['address'] }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="left" valign="top"
                                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                                        <div><strong>Note per il rider</strong></div>
                                        <div>{{ $order['notes'] }}</div>
                                    </td>
                                </tr>
                ...
                <tr>
                    <td align="left" valign="top" class="content-item"
                        style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:30px 0 30px 0;">
                        <p style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;margin:0;">Tutto lo staff di
                            Deliveboo ti ringrazione per la fiducia, spero il nostro servizio sia stato di tuo
                            gradimento. A Presto <span style="font-size:20px">&#128513;</span></p>
                    </td>
                </tr>
            </tbody>
        </table>
                ...
                <tr>
                    <td align="center" valign="middle" class="btn-content"
                        ...
                        <a href="http://127.0.0.1:8000/" target="_blank"
                            style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#4a4a4a !important;display:block;font-family:Arial, sans-serif;font-size:13px;font-weight:bold;text-decoration:none;">DeliveBoo
                            Home</a>
                    </td>
                </tr>
            </tbody>
