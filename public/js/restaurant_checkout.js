...
var _require2 = __webpack_require__(/*! chart.js */ "./node_modules/chart.js/dist/chart.esm.js"),
...
var app = new Vue({
  ...
  methods: {
    ...
    sendData: function sendData() {
      ...
      /* Validation */
      if (this.formData.name && this.formData.surname && this.formData.address && this.formData.telephone_number && this.formData.email) {
        this.errorArrayValidation = []; // Form Data
